...
function Fourth() {
    return (
        <div className=' lg:h-[100vh] h-[150vh] flex flex-col pl-8 lg:pl-0 lg:flex-row items-center  justify-around w-full bg-black'>
            ...
            <div className='flex justify-center mr-20 rounded-3xl items-center ring p-2' style={{ boxShadow: 'inset 0px -5px 6px 0px rgba(250, 250, 255, 0.16), inset 4px 6px 11px 1px rgba(38, 37, 37, 0.24)' }} ring-offset-5 ring-6 ring-white>
